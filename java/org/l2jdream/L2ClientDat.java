...
import org.l2jdream.actions.MassRecryptor;
import org.l2jdream.actions.MassTxtPacker;
import org.l2jdream.actions.MassTxtUnpacker;
import org.l2jdream.actions.OpenDat;
import org.l2jdream.actions.SaveDat;
import org.l2jdream.actions.SaveTxt;
import org.l2jdream.clientcryptor.crypt.DatCrypter;
import org.l2jdream.config.ConfigDebug;
import org.l2jdream.config.ConfigWindow;
import org.l2jdream.forms.JPopupTextArea;
import org.l2jdream.util.Util;
import org.l2jdream.xml.CryptVersionParser;
import org.l2jdream.xml.DescriptorParser;
...
public class L2ClientDat extends JFrame
{
	...
	public L2ClientDat()
	{
		setTitle("L2ClientDat Editor - L2JDream Edition");
		...
		icons.add(new ImageIcon("." + File.separator + "images" + File.separator + "64x64.png").getImage());
		icons.add(new ImageIcon("." + File.separator + "images" + File.separator + "128x128.png").getImage());
		setIconImages(icons);
